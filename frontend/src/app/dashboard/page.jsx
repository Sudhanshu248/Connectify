...
export default function Dashboard(){
    ...
    //     const result = await dispatch(loginUser({ email: "test@example.com", password: "password123" }));
                ...
                return (
                  <div key={post._id} className={styles.singleCard}>
                    <div className={styles.singleCard__profileContainer}>
                      <img className={styles.userProfile} src={`${BASE_URL}/uploads/${authState.user.userId?.profilePicture}`} />
                      <div>
...
//       {authState.profileFetched && authState.user && authState.user.userId ? (
  ...
  //       ) : (
    ...
    //       )}
    //   </div> 
    /* <img className={styles.userProfile} src={`${BASE_URL}/uploads/${post.userId.profilePicture}`} alt="Profile Image" />
    <div className={styles.postContent}>
      <h4>{post.userId.name}</h4>
      <p>{post.body}</p>
      {post.media && <img className={styles.postImage} src={`${BASE_URL}/uploads/${post.media}`} alt="Post Image" />}
    </div> */